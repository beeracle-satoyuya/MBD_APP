...
class BeautyDiagnosisComponent extends Component
{
    public $currentPhase = 'intro'; // intro, category, subcategory, result
    ...
    public function selectSubCategory($subCategory)
    {
        ...
        if (isset($this->productData[$this->selectedCategory][$this->selectedSubCategory]) && is_array($this->productData[$this->selectedCategory][$this->selectedSubCategory])) {
            foreach ($this->productData[$this->selectedCategory][$this->selectedSubCategory] as $product) {
                if ($product !== null && is_array($product) && isset($product['name']) && !empty($product['name']) && isset($product['image']) && isset($product['url'])) {
                    $this->recommendations[] = $product;
                }
            }
        }
    ...
    {
        return view('livewire.beauty-diagnosis-component');
    }
}
